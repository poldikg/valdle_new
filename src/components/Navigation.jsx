...
const Navigation = (props) => {
    ...
    const navMenu = props.navigationData.map(item => <Link style={removeTextDecoration} to={`/${item.name}`}> <div onClick={() => removeFromLocalStorage(item.name)} className="nav-item"> 
